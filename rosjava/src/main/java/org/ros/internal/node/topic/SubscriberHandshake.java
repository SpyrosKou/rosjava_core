...
public final class SubscriberHandshake extends BaseClientHandshake {
    ...
    @Override
    public final boolean handshake(final ConnectionHeader incommingConnectionHeader) {
        if (LOGGER.isInfoEnabled()) {
            LOGGER.info("Outgoing subscriber connection header: " + outgoingConnectionHeader
                    + "Incoming publisher connection header: " + incommingConnectionHeader);
        }
        ...
        final String incomingMd5Checksum =
