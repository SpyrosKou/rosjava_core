...
This fork is primarily licensed under the Apache License 2.0. See [LICENSE](./LICENSE).
...
Most source files in this repository are Apache-2.0. The legacy Python integration test scripts under [`rosjava/test`](./rosjava/test) retain their original BSD license headers and should be treated accordingly.
