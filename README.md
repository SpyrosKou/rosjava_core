...
A pure Java implementation of core ROS 1 client functionality.   
The [SpyrosKou/rosjava_core](https://github.com/SpyrosKou/rosjava_core) fork targets desktop and server JRE usage, tracks newer Java and Gradle releases, and keeps a library-oriented public API with focused reliability, transport, and developer-experience improvements.
